...
def config_components():
    config_network("100_r1", ["20.0.51.1", "20.0.1.1"])
    config_network("200_r1", ["20.0.52.1", "20.0.1.2", "20.0.2.1", "20.0.3.1"])
    config_network("300_r1", ["20.0.53.1", "20.0.2.2", "20.0.5.1", "20.0.4.1"])
    config_network("400_r1", ["20.0.54.1", "20.0.4.2", "20.0.6.1", "20.0.7.1"])
    config_network("500_r1", ["20.0.7.2", "20.0.8.1", "20.0.9.1"])
    config_network("600_r1", ["20.0.56.1", "20.0.3.2", "20.0.10.1"])
    config_network("700_r1", ["20.0.10.2", "20.0.11.1", "20.0.12.1"])
    config_network("800_r1", ["20.0.8.2", "20.0.12.2"])
    config_network("900_r1", ["20.0.5.2", "20.0.6.2"])
    config_network("1000_r1", ["20.0.11.2"])
    config_network("1100_r1", ["20.0.9.2"])
