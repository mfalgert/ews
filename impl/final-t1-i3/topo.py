...
class QuaggaTopo(Topo):
    def addQuaggaLinks(self, quaggas):
        ...
        self.addLink(quaggas["100_rr"], quaggas["100_r2"], delay="2ms")
        self.addLink(quaggas["100_r1"], quaggas["100_rr"], delay="2ms")
        self.addLink(quaggas["200_r2"], quaggas["300_r1"], delay="10ms")
        self.addLink(quaggas["200_r2"], quaggas["5200_rt"], delay="10ms")
        self.addLink(quaggas["200_rr"], quaggas["200_r2"], delay="2ms")
        self.addLink(quaggas["200_r1"], quaggas["200_rr"], delay="2ms")
        self.addLink(quaggas["300_r2"], quaggas["400_r1"], delay="10ms")
        self.addLink(quaggas["300_r2"], quaggas["5300_rt"], delay="10ms")
        self.addLink(quaggas["300_rr"], quaggas["300_r2"], delay="2ms")
        self.addLink(quaggas["300_r1"], quaggas["300_rr"], delay="2ms")
        self.addLink(quaggas["400_r2"], quaggas["500_r1"], delay="10ms")
        self.addLink(quaggas["400_r2"], quaggas["5400_rt"], delay="10ms")
        self.addLink(quaggas["400_rr"], quaggas["400_r2"], delay="2ms")
        self.addLink(quaggas["400_r1"], quaggas["400_rr"], delay="2ms")
        self.addLink(quaggas["500_r2"], quaggas["600_r1"], delay="10ms")
        self.addLink(quaggas["500_r2"], quaggas["5500_rt"], delay="10ms")
        self.addLink(quaggas["500_rr"], quaggas["500_r2"], delay="2ms")
        self.addLink(quaggas["500_r1"], quaggas["500_rr"], delay="2ms")
        self.addLink(quaggas["600_r2"], quaggas["1300_r1"], delay="10ms")
        self.addLink(quaggas["600_r2"], quaggas["5600_rt"], delay="10ms")
        self.addLink(quaggas["600_rr"], quaggas["600_r2"], delay="2ms")
        self.addLink(quaggas["600_r1"], quaggas["600_rr"], delay="2ms")
    ...
    def addQuaggas(self):
        ...
        quaggaHosts.append(QuaggaHost(name="100_rr", ip="20.1.0.5/30", mac="00:00:00:01:00:12"))
        quaggaHosts.append(QuaggaHost(name="200_rr", ip="20.2.0.5/30", mac="00:00:00:02:00:12"))
        quaggaHosts.append(QuaggaHost(name="300_rr", ip="20.3.0.5/30", mac="00:00:00:03:00:12"))
        quaggaHosts.append(QuaggaHost(name="400_rr", ip="20.4.0.5/30", mac="00:00:00:04:00:12"))
        quaggaHosts.append(QuaggaHost(name="500_rr", ip="20.5.0.5/30", mac="00:00:00:05:00:12"))
        quaggaHosts.append(QuaggaHost(name="600_rr", ip="20.6.0.5/30", mac="00:00:00:06:00:12"))
        return quaggaHosts
