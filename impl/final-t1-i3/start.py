...
def config_components():
    config_network("100_r1", ["20.1.0.1"])
    config_network("200_r1", ["20.0.1.2", "20.2.0.1"])
    config_network("300_r1", ["20.0.3.2", "20.3.0.1"])
    config_network("400_r1", ["20.0.4.2", "20.4.0.1"])
    config_network("500_r1", ["20.0.5.2", "20.5.0.1"])
    config_network("600_r1", ["20.0.6.2", "20.6.0.1"])
    config_network("700_r1", ["20.0.2.2", "20.7.0.1"])
    config_network("800_r1", ["20.0.8.2", "20.8.0.1"])
    config_network("900_r1", ["20.0.9.2", "20.9.0.1"])
    config_network("1000_r1", ["20.0.10.2", "20.10.0.1"])
    config_network("1100_r1", ["20.0.11.2", "20.11.0.1"])
    config_network("1200_r1", ["20.0.12.2", "20.12.0.1"])
    config_network("1300_r1", ["20.0.7.2", "20.0.13.2", "20.13.0.1"])
    
    config_network("100_r2", ["20.0.51.1", "20.0.2.1", "20.1.0.6"])
    config_network("200_r2", ["20.0.52.1", "20.2.0.6"])
    config_network("300_r2", ["20.0.53.1", "20.3.0.6"])
    config_network("400_r2", ["20.0.54.1", "20.4.0.6"])
    config_network("500_r2", ["20.0.55.1", "20.5.0.6"])
    config_network("600_r2", ["20.0.56.1", "20.6.0.6"])
    config_network("700_r2", ["20.7.0.2"])
    config_network("800_r2", ["20.8.0.2"])
    config_network("900_r2", ["20.9.0.2"])
    config_network("1000_r2", ["20.10.0.2"])
    config_network("1100_r2", ["20.11.0.2"])
    config_network("1200_r2", ["20.12.0.2"])
    config_network("1300_r2", [])
    ...
    config_network("100_rr", ["20.1.0.2"])
    config_network("200_rr", ["20.2.0.2"])
    config_network("300_rr", ["20.3.0.2"])
    config_network("400_rr", ["20.4.0.2"])
    config_network("500_rr", ["20.5.0.2"])
    config_network("600_rr", ["20.6.0.2"])

def setup_forwarder(node):
    dst = "10.0.1.10"
    single_host_per_asn = False   
    ...
    if src != dst or single_host_per_asn:
...
def setup_services():
    ...
    setup_forwarder("100_r2")
    setup_forwarder("200_r2")
    setup_forwarder("300_r2")
    setup_forwarder("400_r2")
    setup_forwarder("500_r2")
    setup_forwarder("600_r2")
    setup_forwarder("700_r2")
    setup_forwarder("800_r2")
    setup_forwarder("900_r2")
    setup_forwarder("1000_r2")
    setup_forwarder("1100_r2")
    setup_forwarder("1200_r2")
